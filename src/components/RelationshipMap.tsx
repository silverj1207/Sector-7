            ...
            >
              <div>
                <div className="flex justify-between items-start mb-2">
                  ...
                  {char.rank && (
                    <span className="text-[11px] font-bold text-emerald-500/80 font-mono px-2 py-0.5 rounded-full border border-emerald-900/30 bg-emerald-950/20">
                      {char.rank}
                    </span>
                  )}
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-[11px] md:text-xs text-zinc-400 font-mono leading-relaxed">
                    {char.role}
                  </div>
                </div>
              </div>
